...
class Util {
    ...
    static parseTemplateName(templateName) {
        return Util.parseComponentName(templateName, Constants.ComponentType.Template);
    }
    ...
    static parseSnippetName(snippetName) {
        return Util.parseComponentName(snippetName, Constants.ComponentType.Snippet);
    }
}
