...
class Util {
     ...
     *     1. Template/input names on their own, e.g. `latex-common`
     *     2. Module and template/input names separated with a slash, e.g. `TimboKZ/latex-common`
     *
     * @param {string} string
     * @returns {boolean}
     */
     ...
     * @returns {{module?: string, template?: string, input?: string}}
     * @private
     */
    static _parseComponentName(componentName, componentType) {
    ...
    /**
     * @param templateName
     * @returns {{module?: string, template: string}}
     */
    static parseTemplateName(templateName) {
        return Util._parseComponentName(templateName, Constants.ComponentType.Template);
    }

    /**
     * @param inputName
     * @returns {{module?: string, input: string}}
     */
    static parseInputName(inputName) {
        return Util._parseComponentName(inputName, Constants.ComponentType.Input);
    }
}
