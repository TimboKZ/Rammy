...
const {RammyError, ErrorCode} = require('./Util');
...
class Config {
    ...
    load(force = false) {
        ...
        return Promise.resolve()
            ...
            .then(configData => {
                ...
                this.rammyrcDir = upath.dirname(this.rammyrcPath);
            });
    }
    ...
    getModuleData(data) {
        ...
        return Promise.resolve()
            ...
            .then(() => {
                ...
                moduleData.absPath = upath.resolve(this.rammyrcDir, modulePath);
            ...
            .then(moduleFolderExists => {
                ...
                moduleConfigPath = upath.join(moduleData.absPath, Constants.ConfigFileName);
    ...
    static _processConfigComponent(data) {
        return {
            ...
            absPath: upath.resolve(data.module.absPath, data.configComponentData.path),
